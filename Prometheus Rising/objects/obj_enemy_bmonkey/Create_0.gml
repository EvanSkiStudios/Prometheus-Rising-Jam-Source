...
object_is_audioemitter(snd_sfx_bmonkey_hurt,false,1,z,100,50);
...
#region sprite_directions
	#region walking
		...
		sprite_walk_dir_array[0] = spr_enmy_bmonkey_walk_R;
		sprite_walk_dir_array[1] = spr_enmy_bmonkey_walk_BR;
		sprite_walk_dir_array[2] = spr_enmy_bmonkey_walk_B;
		sprite_walk_dir_array[3] = spr_enmy_bmonkey_walk_BL;
		sprite_walk_dir_array[4] = spr_enmy_bmonkey_walk_L;
		sprite_walk_dir_array[5] = spr_enmy_bmonkey_walk_FL;
		sprite_walk_dir_array[6] = spr_enmy_bmonkey_walk_F;
		sprite_walk_dir_array[7] = spr_enmy_bmonkey_walk_FR;
	#endregion
	
	#region attack_ranged
		sprite_attack_ranged_dir_array = array_create(1,0);
		sprite_attack_ranged_dir_array[0] = 0;
		/*
	...
	#region melee_ranged
		...
		sprite_attack_melee_dir_array[0] = spr_enmy_bmonkey_attack_melee_R;
		sprite_attack_melee_dir_array[1] = spr_enmy_bmonkey_attack_melee_BR;
		sprite_attack_melee_dir_array[2] = spr_enmy_bmonkey_attack_melee_B;
		sprite_attack_melee_dir_array[3] = spr_enmy_bmonkey_attack_melee_BL;
		sprite_attack_melee_dir_array[4] = spr_enmy_bmonkey_attack_melee_L;
		sprite_attack_melee_dir_array[5] = spr_enmy_bmonkey_attack_melee_FL;
		sprite_attack_melee_dir_array[6] = spr_enmy_bmonkey_attack_melee_F;
		sprite_attack_melee_dir_array[7] = spr_enmy_bmonkey_attack_melee_FR;
	#endregion
