...
trigger_shape = NewColAABBFromMinMax(new Vector3(self.x - 3, self.y - 3, 0), new Vector3(self.x + (32 * image_xscale) + 3, self.y + (32 * image_yscale) + 3, 32));

//collision check array
global.walls_array[global.walls_array_index] = id;
global.walls_array_index += 1;

object_is_audioemitter(snd_sfx_door,false,1,0,200,100);